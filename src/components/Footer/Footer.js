...
import mainLogo from '../../assets/footerLogo.svg'
    ...
    <div className={classes.footerContainer}>
       ...
       <div className={classes.footerBox}>
        ...
        <div className={classes.footerBox}>
            ...
            <p className={classes.mainFooterItem}>{t('footerLink.2')}</p>
        </div>
        <div className={classes.footerBox}>
...
{/*         <div className={classes.footerBox}>
        ...
        <div className={classes.logoHolder}>
            <a target="_blank" href="https://uniri.hr/en/home/"><img src={logo1}/></a>
            <a target="_blank" href="https://uniri.hr/en/home/"><img src={logo2}/></a>
            <a target="_blank" href="https://www.ufri.uniri.hr/hr/"><img src={logo3}/></a>
        </div>
    </div>
)}
